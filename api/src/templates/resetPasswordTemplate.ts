...
const ResetPasswordUser = function (user: string, newPassword: string) {
  const html = `
    <!DOCTYPE html>
      <html lang="en">
        <head>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="text_block block-1" role="presentation" style="word-break: break-word;" width="100%">
                          ...
                          <tr>
                              <td class="pad" style="padding-top:15px;">
                                <div style="font-family: sans-serif">
                                    <div class="" style="font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 12px; color: #2b2d49; line-height: 1.5;">
                                        <p style="margin: 0; font-size: 14px; text-align: center; letter-spacing: 2px;"><span style="font-size:30px;caret-color:#152a6d;"><strong>RESTABLECER CONTRASEÑA</strong></span></p>                 
                                    </div>
                                </div>
                              </td>
                          </tr>
                  ...
                  <tr>
                    <td class="column column-1" style="font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 10px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                              ...
                              <td class="pad" style="padding-left:30px;padding-right:30px;">
                                <div style="font-family: sans-serif">
                                    <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                      ...
                                      <p style="margin: 0; text-align: justify; font-size: 15px;">Recientemente solicitó restablecer la contraseña de su cuenta <b>PropTech</b>. Use la siguiente contraseña para acceder:</p>
                                      <p style="margin: 0; font-size: 15px; text-align: center; padding: 10px"><b>${newPassword}</b></p>
                                      <p style="margin: 0; text-align: justify; font-size: 15px;">Se recomienda actualizar su contraseña. Para ingresar a nuestra plataforma hacer click en la siguiente opción.<p>
                                    </div>
                                </div>
                              </td>
                          </tr>
                        ...
                        <div align="center" class="alignment">
                          <a href="${process.env.URL}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#2b2d49;border-radius:9px;width:auto;border-top:1px solid #2B2D49;font-weight:400;border-right:1px solid #2B2D49;border-bottom:1px solid #2B2D49;border-left:1px solid #2B2D49;padding-top:5px;padding-bottom:5px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:2px;"><span dir="ltr" style="word-break: break-word; line-height: 32px;">ACCEDER</span></span></a>
                        </div>
                        <br><br><br>
                    </td>
                  </tr>
