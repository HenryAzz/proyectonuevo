...
const brokerForm = function (broker: string, user, data) {
  const html = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" class="text_block block-1" role="presentation" style="word-break: break-word;" width="100%">
                        ...
                        <tr>
                            <td class="pad" style="padding-top:15px;">
                              <div style="font-family: sans-serif">
                                  <div class="" style="font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 12px; color: #2b2d49; line-height: 1.5;">
                                      <p style="margin: 0; font-size: 14px; text-align: center; letter-spacing: 2px;"><span style="font-size:30px;caret-color:#152a6d;"><strong>SOLICITUD DE FORMULARIO</strong></span></p>     
                                  </div>
                              </div>
                            </td>
                        </tr>
                            ...
                            <td class="pad" style="padding-left:30px;padding-right:30px;">
                              <div style="font-family: sans-serif">
                                  <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                      ...
                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Me pongo en contacto con usted para informarle que se ha registrado un nuevo <b>formulario</b> de una propiedad del rubro <b>${data.type_prop[0].toUpperCase() + data.type_prop.substring(1)}</b> del cual es responsable. A continuación, le proporciono los detalles para que proceda a su revisión:<p>
