...
const createSupplierSignal = function (user: string, property) {
  const html = `
      <!DOCTYPE html>
      <html lang="en">
         <head>
                              ...
                              <td class="pad" style="padding-left:30px;padding-right:30px;">
                                 <div style="font-family: sans-serif">
                                    <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                          ...
                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Gracias por su interés en nuestra inmobiliaria <b>PropTech</b>. Hemos recibido su solicitud para vender su propiedad y nos complace que haya considerado trabajar con nosotros.<p>
                                          ...
                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Con la información proporcionada, evaluaremos su propiedad y le estaremos dando una respuesta en los próximos días.<p>

                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Tenga en cuenta que nuestro objetivo es proporcionarle un servicio personalizado y profesional en cada paso del camino. Trabajaremos arduamente para garantizar que su experiencia de venta sea lo más exitosa posible.<p>
...
export default createSupplierSignal;
