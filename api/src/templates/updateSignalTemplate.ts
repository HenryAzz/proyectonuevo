const updateSignal = function (user: string, property, situation: string, operation: string) {
  const html = `
      <!DOCTYPE html>
      <html lang="en" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
         ...
         <body style="background-color: #fffaf2; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
            <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="background-color: #fffaf2; background-image: none; background-position: top left; background-size: auto; background-repeat: no-repeat;" width="100%">
               <tbody>
                  <tr>
                     <td>
                                                   ...
                                                   <tr>
                                                      <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                         <div align="center" class="alignment" style="line-height:10px"><a href="#" style="outline:none" tabindex="-1" target="_blank">
                                                            <img alt="PropTech" src="https://res.cloudinary.com/dmwmdylpa/image/upload/v1683407215/logo_kwplct.png" style="display: block; height: auto; border: 0; width: 126px; max-width: 100%;" title="PropTech" width="126"/></a>
                                                         </div>
                                                      </td>
                                                   </tr>
                                                </table>
                                                         ...
                                                         <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                            <tr>
                                                               <td class="alignment" style="text-align:center;font-size:0px;">
                                                                  ...
                                                                  <div class="menu-trigger" style="display:none;max-height:0px;max-width:0px;font-size:0px;overflow:hidden;"><label class="menu-label" for="memu-r0c0m1" style="height: 36px; width: 36px; display: inline-block; cursor: pointer;  user-select: none; text-align: center; color: #001e3e; text-decoration: none; background-color: transparent; border-radius: 0;"><span class="menu-open" style="font-size:26px;line-height:31.5px;">☰</span><span class="menu-close" style="display:none;font-size:26px;line-height:36px;">✕</span></label></div>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-1" role="presentation" style="word-break: break-word;" width="100%">
                                       ...
                                       <tr>
                                          <td class="pad" style="padding-top:15px;">
                                             <div style="font-family: sans-serif">
                                                <div class="" style="font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 12px; color: #2b2d49; line-height: 1.5;">
                                                   <p style="margin: 0; font-size: 14px; text-align: center; letter-spacing: 2px;"><span style="font-size:30px;caret-color:#152a6d;"><strong>RESPUESTA DE SOLICITUD</strong></span></p>
                                                   ${
                                                      situation ==="Aceptado"
                                                      ? `<p style="margin: 0; font-size: 14px; text-align: center; letter-spacing: 2px;"><span style="font-size:22px;"><em><span style="caret-color:#152a6d;">Hoy es un día Especial</span></em></span></p>`
                                                      : ""
                                                   }
                                          ...
                                          <td class="pad" style="padding-left:30px;padding-right:30px;">
                                             <div style="font-family: sans-serif">
                                                <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                                   <p style="margin: 0; text-align: justify; font-size: 14px;"><span style="font-size:15px;color:#2b2d49;">Estimado cliente <b>${user}</b>, ${ situation ==="Aceptado" ? `
                                                      <b>PropTech</b> se complace en comunicarle que el registro de solicitud fue <b>${situation}</b> para ${operation} la propiedad.
                                                   ` : `
                                                      lamentamos comunicarle que el registro de solicitud fue <b>${situation}</b> para ${operation} la propiedad.` 
                                                   } 
                                                   La misma que tiene las siguientes características:</span></p>
                                                   ...
                                                   ${ situation ==="Aceptado" ? `
                                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Uno de nuestros agentes de bienes raíces se pondrá en contacto con usted para discutir los siguientes pasos y programar una visita a la propiedad mencionada anteriormente.<p>

                                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Tenga en cuenta que nuestro objetivo es proporcionarle un servicio personalizado y profesional en cada paso del camino. Trabajaremos arduamente para garantizar que su experiencia sea lo más exitosa posible.<p>
                                                   ` : "" } 

                                                   <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Gracias de nuevo por su interés en <b>PropTech</b>.<p>
                                       ...
                                       <tr>
                                          <td class="pad" style="color:#4a4a4a;font-family:inherit;font-size:14px;text-align:center;">
                                             <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                <tr>
                                                   <td class="alignment" style="text-align:center;font-size:0px;">
                                                      <div class="menu-links"><a href="#" style="padding-top:5px;padding-bottom:5px;padding-left:5px;padding-right:5px;display:inline-block;color:#4a4a4a;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;text-decoration:none;letter-spacing:normal;" target="_self">Equipo de Soporte PropTech</a></div>
                                                   </td>
                                                </tr>
                                             </table>
                                          </td>
