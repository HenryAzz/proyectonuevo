const createClientUser = function (user: string) {
  const html = `
  <!DOCTYPE html>
     <html lang="en">
        <head>
                       ...
                       <table border="0" cellpadding="0" cellspacing="0" class="text_block block-1" role="presentation" style="word-break: break-word;" width="100%">
                          ...
                          <tr>
                             <td class="pad" style="padding-top:15px;">
                                <div style="font-family: sans-serif">
                                   <div class="" style="font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 12px; color: #2b2d49; line-height: 1.5;">
                                         <p style="margin: 0; font-size: 14px; text-align: center; letter-spacing: 2px;"><span style="font-size:30px;caret-color:#152a6d;"><strong>BIENVENIDO</strong></span></p>                 
                                   </div>
                                </div>
                             </td>
                          </tr>
                             ...
                             <td class="pad" style="padding-left:30px;padding-right:30px;">
                                <div style="font-family: sans-serif">
                                   <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 15px">Estimado <b>${user},</b></p><br>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">En nombre de <b>PropTech</b>, me gustaría darte la bienvenida a nuestra familia de clientes. Nos sentimos honrados de que hayas elegido trabajar con nosotros en tu búsqueda para encontrar la propiedad perfecta.</p>
                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Estamos aquí para ayudarte en cada paso del camino. Nuestro equipo de agentes de bienes raíces dedicados están a tu disposición para responder a cualquier pregunta que tengas sobre el proceso de compra, así como para ayudarte a encontrar la propiedad de tus sueños.<p>
                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Nos comprometemos a trabajar incansablemente para asegurarnos de que tu experiencia de compra sea lo más fácil y agradable posible. Por favor, no dudes en ponerte en contacto con nosotros en cualquier momento si necesitas ayuda o tienes alguna pregunta.<p>
                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Gracias de nuevo por elegir <b>PropTech</b>. Esperamos tener una relación duradera contigo y ayudarte a encontrar la propiedad perfecta.<p>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Saludos cordiales,<p>

                                      <p style="margin: 0; text-align: center; font-size: 15px; padding-top: 10px"><b>PropTech</b><p> <br>
                                   </div>
                                </div>
                             </td>
                          </tr>
