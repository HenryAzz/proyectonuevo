                       ...
                       <tr>
                             ...
                             <div style="font-family: sans-serif">
                                   <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                          ...
                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">En nombre de todo el equipo de <b>PropTech</b>, me gustaría darte la bienvenida a nuestro equipo. Estamos emocionados de tenerte a bordo y esperamos trabajar juntos para lograr tus objetivos de venta de propiedades.</p>
                                   
                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Nos comprometemos a brindarte el apoyo que necesitas para alcanzar el éxito en tu carrera inmobiliaria. Nuestro equipo de agentes de bienes raíces dedicados está a tu disposición para ayudarte en cada paso del camino, desde la preparación de las propiedades para la venta hasta la promoción y el cierre de la venta.<p>

                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Por favor, no dudes en ponerte en contacto con nosotros si necesitas ayuda o tienes alguna pregunta. Estamos aquí para ayudarte a alcanzar tus metas y esperamos trabajar contigo para lograr un gran éxito.<p>

                                          <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Gracias de nuevo por elegir <b>PropTech</b>. Esperamos tener una relación duradera contigo.<p>
