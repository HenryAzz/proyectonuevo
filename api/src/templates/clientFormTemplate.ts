...
const clientForm = function (user, data) {
  const html = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
                            ...
                            <td class="pad" style="padding-left:30px;padding-right:30px;">
                              <div style="font-family: sans-serif">
                                  <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                      <p style="margin: 0; text-align: justify; font-size: 15px;">Hola <b>${user.dataValues.name},</b></p><br>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Gracias por completar el formulario de registro de propiedad en nuestra inmobiliaria <b>PropTech</b>. Nos complace recibir su solicitud y nos pondremos en contacto con usted lo antes posible.<p>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Queremos asegurarnos de que hemos recibido toda la información necesaria para proceder con el proceso de registro. Si falta algún documento o detalles adicionales, nos pondremos en contacto con usted para solicitarlos.<p>
                                      ...
                                      <p style="margin: 0; text-align: center; font-size: 15px; padding-top: 10px"><b>Datos de Operación</b><p>

                                      <ul>
                                        <li><b>TÍTULO: ${data.title[0].toUpperCase() + data.title.substring(1)}</b></li>
                                        <li><b>DESCRIPCIÓN: ${data.description}</b></li>
                                        <li><b>PRECIO: ${data.unit_price}</b></li>
                                      </ul>
                                      ...
                                      <ul>
                                        ...
                                        <li><b>DNI: ${data.dni}</b></li>
                                        <li><b>TELÉFONO: ${data.tel}</b></li>
                                      ...
                                      <ul>
                                        <li><b>TIPO DE PROPIEDAD: ${data.type_prop}</b></li>
                                        <li><b>TIPO DE VIVIENDA: ${data.type_vivienda}</b></li>
                                        <li><b>DIRECCIÓN: ${data.address}</b></li>
                                        <li><b>NÚMERO: ${data.number}</b></li>
                                        <li><b>APARTAMENTO: ${data.apartment}</b></li>
                                        <li><b>PISO: ${data.floor}</b></li>
                                        <li><b>UBICACIÓN: ${data.location}</b></li>
                                        <li><b>PROVINCIA/ESTADO: ${data.province}</b></li>
                                        <li><b>CÓDIGO POSTAL: ${data.postalCode}</b></li>
                                      </ul>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Agradecemos su interés en nuestra agencia inmobiliaria y estamos comprometidos a proporcionarle un servicio de calidad. Nuestro equipo de expertos se esforzará por encontrar la mejor opción para satisfacer sus necesidades y cumplir sus expectativas.<p>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Si tiene alguna pregunta o necesita más información, no dude en ponerse en contacto con nosotros a través de este correo electrónico o llamándonos al número de teléfono proporcionado en el formulario de registro.<p>

                                      <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Una vez más, agradecemos su confianza en nuestra inmobiliaria <b>PropTech</b> y esperamos tener la oportunidad de trabajar juntos.<p>
