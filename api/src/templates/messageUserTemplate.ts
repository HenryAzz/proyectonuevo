const messageUser = function (user: string, message: string, broker) {
  const html = `
  <!DOCTYPE html>
  <html lang="en">
     <head>
                      ...
                      <tr>
                       ...
                       <tr>
                          <td class="pad" style="padding-top:15px;">
                             <div style="font-family: sans-serif">
                                 <div class="" style="font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 12px; color: #2b2d49; line-height: 1.5;">
                                    <p style="margin: 0; font-size: 14px; text-align: center; letter-spacing: 2px;"><span style="font-size:30px;caret-color:#152a6d;"><strong>COMUNICADO</strong></span></p>     
                                </div>
                             </div>
                          </td>
                       </tr>
                          ...
                          <td class="pad" style="padding-left:30px;padding-right:30px;">
                             <div style="font-family: sans-serif">
                                <div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #2b2d49; line-height: 1.2;">
                                    ...
                                    <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">${message}.<p>

                                    <p style="margin: 0; text-align: justify; font-size: 15px; padding-top: 10px">Atentamente,<p>

                                    <p style="margin: 0; text-align: center; font-size: 15px; padding-top: 10px">
                                       <b>${broker.dataValues.name.toUpperCase()}</b><br>
                                       <b>Broker de ${broker.dataValues.division[0].toUpperCase()+broker.dataValues.division.substring(1)}</b><br>
                                       <b>PropTech</b>
                                    <p> <br><br>
                                </div>
                             </div>
